...
const createdAt =
  story?.createdAt?.seconds != null
    ? story.createdAt.seconds * 1000 // Firestore Timestamp → ms
    : typeof story?.createdAt === 'number'
    ? (story.createdAt > 1e12 ? story.createdAt : story.createdAt * 1000) // ms vs s
    : +new Date(story.createdAt) // fallback (npr. ISO string)
