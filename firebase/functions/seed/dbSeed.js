...
const seedAdminFeedPosts = async jsonFileName => {
  // Make sure this gets called AFTER the admin user is created in Firebase Auth
  console.log(`Creating feed posts for admin`)
  const admin = await getOrCreateAdminUser()
  if (admin === null) {
    console.log(`Admin user doesn't exist, exiting...`)
    return
  }
